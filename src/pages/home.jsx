export default function Home() {
  return (
    <div className="pt-8">
      <h1 className="text-4xl md:text-5xl text-center mb-6 leading-tight w-full">
      ...
      {/* EXPLORE CARDS: Faded parchment borders, no hard box backgrounds */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 relative z-20 max-w-4xl mx-auto px-4">
        <div className="bg-parchment/20 backdrop-blur-sm border border-gothic-gold/30 p-6 shadow-xl hover:border-gothic-purple/40 transition-all duration-300 hover:-translate-y-1">
          <h3 className="font-heading text-gothic-gold text-lg mb-2">Explore Valerium</h3>
          <p className="text-gothic-parchment/70 text-sm font-body leading-relaxed">Flooded streets, gilded armor, and empty forums.</p>
        </div>
        <div className="bg-parchment/20 backdrop-blur-sm border border-gothic-gold/30 p-6 shadow-xl hover:border-gothic-purple/40 transition-all duration-300 hover:-translate-y-1">
          <h3 className="font-heading text-gothic-gold text-lg mb-2">Explore Drümen</h3>
          <p className="text-gothic-parchment/70 text-sm font-body leading-relaxed">The smell of hot metal and the heartbeat of the forges.</p>
        </div>
        <div className="bg-parchment/20 backdrop-blur-sm border border-gothic-gold/30 p-6 shadow-xl hover:border-gothic-purple/40 transition-all duration-300 hover:-translate-y-1">
          <h3 className="font-heading text-gothic-gold text-lg mb-2">Explore Free Cities</h3>
          <p className="text-gothic-parchment/70 text-sm font-body leading-relaxed">Salt wind, spices, and the desperate energy of denial.</p>
        </div>
      </div>

      {/* CHANGELOG BOX: Just a faded dashed line */}
      <div className="relative z-20 max-w-4xl mx-auto px-4 mt-8">
        <div className="border border-dashed border-gothic-gold/30 rounded-lg p-5">
          ...
          <p className="text-gothic-parchment/60 text-xs font-body italic">[Placeholder: Newest lore entry will be added here automatically soon.]</p>
        </div>
      </div>
      </div>
    </div>
